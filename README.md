...
Track outline geometry for São Paulo, Zandvoort, Imola, Lusail, Yas Island,
Sakhir, Jeddah, Austin, and Baku is derived from the
[f1-circuits](https://github.com/bacinger/f1-circuits) dataset by Tomislav
Bacinger, used under its MIT license.
